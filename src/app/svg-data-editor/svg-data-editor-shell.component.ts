...
import { OvaadSvgStyleProperty, OvaadGraphicAttribute, OvaadGraphicObject, OvaadSvgDataObject, ViewBoxParameters } from '../interfaces';
import { CreateGraphicObjectForm } from './functions/create-graphic-object-form';
